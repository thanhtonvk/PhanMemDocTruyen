...
public class ThemTapTruyenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them_tap_truyen);
        anhXa();
        onClick();
    }
    ...
    private void anhXa() {
        ...
        tapTruyenDAO = new TapTruyenDAO(ThemTapTruyenActivity.this);
    }
    ...
    private void onClick() {
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tapTruyenDAO.themTapTruyen(truyen, Truyen.TRUYEN.getMaTruyen()) > 0) {
